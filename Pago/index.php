      ...
      <div class="card">
         ...
         <div class="card-body">
            ...
            <div class="row">
               <div class="col-3">
                  <label>MM</label>
                  <input value="11" data-conekta="card[exp_month]" class="form-control" type="text" maxlength="2">
               </div>
               <div class="col-3">
                  <label>AA</label>
                  <input value="20" data-conekta="card[exp_year]" class="form-control" type="text" maxlength="2">
               </div>
